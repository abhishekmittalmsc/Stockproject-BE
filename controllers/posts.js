...
export const createUser = async (req, res) => {
    ...
    const { Name, pin, city, state, country, phoneNumber, mailId } = req.body;

    const newUserRegistration = new UserRegistration({ Name, pin, city, state, country, phoneNumber, mailId})
